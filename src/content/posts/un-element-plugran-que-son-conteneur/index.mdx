...
De cette façon, notre élément `breakout` sera plus large de 4ch (2 x 2ch), malheureusement ça n'est pas responsive. Il sera nécessaire d'ajouter une `media querie` pour être certain de ne pas avoir de débordement.
